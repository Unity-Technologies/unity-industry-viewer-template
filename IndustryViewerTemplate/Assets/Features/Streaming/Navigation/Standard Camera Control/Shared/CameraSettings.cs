...
{
    /// <summary>
    /// Provides setting values for a <see cref="FreeFlyCamera"/>.
    /// </summary>
    [CreateAssetMenu(fileName = nameof(CameraSettings), menuName = "ScriptableObjects/" + nameof(CameraSettings))]
    public class CameraSettings : ScriptableObject
    {
        ...
        [Tooltip("Linear scaling over default orbit (camera drag) movement speed")]
        public float orbitScaling = 0.15f;
